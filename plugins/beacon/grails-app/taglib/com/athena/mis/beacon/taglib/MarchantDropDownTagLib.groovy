...
import com.mis.beacon.taglib.GetDropDownMarchantTagLibActionService

class MarchantDropDownTagLib extends BaseTagLibExecutor{

    static namespace = "app"

    GetDropDownMarchantTagLibActionService getDropDownMarchantTagLibActionService
     ...
     */
    def dropDownMarchant = { attrs, body ->
        attrs.body = body
        executeTag(getDropDownMarchantTagLibActionService, attrs)
        out << attrs.html
    }
