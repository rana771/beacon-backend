...
class ListTestDomainActionService extends BaseService implements ActionServiceIntf {

     private Logger log = Logger.getLogger(getClass());
    TestDomainService testDomainService
    /**
     * No pre conditions required for searching testDomain domains
     *
     ...
     *
     * 2. pull all testDomain list from database (if no criteria)
     *
    ...
    public Map execute(Map result) {
        try {
            Map resultMap = super.getSearchResult(result, TestDomain.class)
