 ...
 */
class ListSupplierItemActionService extends BaseService implements ActionServiceIntf {
     ...
     *
     * 2. pull all item's of supplier list from database (if no criteria)
     *
    ...
    public Map execute(Map result) {
        try {
            ...
            Map resultMap = super.getSearchResult(result, ListSupplierItemActionServiceModel.class, filterParam)
