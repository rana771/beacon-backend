 ...
 *  For details go through Use-Case doc named 'ListForTruncateSamplingActionService'
 */
class ListForTruncateSamplingActionService extends BaseService implements ActionServiceIntf {
     ...
     *
     * 2. pull all sampling list from database (if no criteria)
     *
    ...
    public Map execute(Map result) {
        try {
            Map resultMap = super.getSearchResult(result, ListForTruncateSamplingActionServiceModel.class)
