...
/**
 * Clear benchmark star
 * For details go through Use-Case doc named 'ClearBenchmarkStarActionService'
 */
class ClearBenchmarkStarActionService extends BaseService implements ActionServiceIntf {
     ...
     * 2. update startTime and endTime of benchmark
    ...
    public Map execute(Map result) {
        try {
            ...
            benchmarkStarService.update(benchMark)
            return result
        } catch (Exception ex) {
            log.error(ex.getMessage())
            throw new RuntimeException(ex)
