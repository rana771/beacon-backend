 ...
 *  For details go through Use-Case doc named 'ListCompanyForResellerActionService'
 */
class ListCompanyForResellerActionService extends BaseService implements ActionServiceIntf {
    ...
    public Map execute(Map result) {
        try {
            Map resultMap = super.getSearchResult(result, ListCompanyForResellerActionServiceModel.class)
