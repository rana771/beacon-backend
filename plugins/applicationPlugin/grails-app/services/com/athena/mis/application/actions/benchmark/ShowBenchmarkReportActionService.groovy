 ...
 *  For details go through Use-Case doc named 'ShowBenchmarkReportActionService'
 */
class ShowBenchmarkReportActionService extends BaseService implements ActionServiceIntf {
    ...
    private static final String NOT_FOUND = "BenchMark not found"
    ...
    /**
     * 1. check benchmark existence
     * 2. build benchmark details object
    ...
    public Map execute(Map result) {
        ...
        String errMsg = checkBenchMarkExistence(benchmark)
        ...
        SystemEntity volumeType = (SystemEntity) appSystemEntityCacheService.read(benchmark.volumeTypeId, appSystemEntityCacheService.SYS_ENTITY_TYPE_BENCHMARK, benchmark.companyId)
        ...
        result.put(VOLUME_TYPE, volumeType.key)
    ...
    private GroovyRowResult getTimeForBenchMark(long benchmarkId) {
        SystemEntity transactionLogType = appSystemEntityCacheService.readByReservedId(appSystemEntityCacheService.SYS_ENTITY_TRANSACTION_LOG_BENCHMARK, appSystemEntityCacheService.SYS_ENTITY_TYPE_TRANSACTION_LOG, super.companyId)
