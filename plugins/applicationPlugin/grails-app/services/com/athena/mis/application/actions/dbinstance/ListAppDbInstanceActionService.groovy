 ...
 *  For details go through Use-Case doc named 'ListAppDbInstanceActionService'
 */
class ListAppDbInstanceActionService extends BaseService implements ActionServiceIntf {
    ...
    public Map execute(Map result) {
        try {
            Map resultMap = super.getSearchResult(result, ListAppDbInstanceActionServiceModel.class)
