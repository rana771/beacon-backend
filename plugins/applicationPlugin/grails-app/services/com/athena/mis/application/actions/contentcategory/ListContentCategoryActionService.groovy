 ...
 */
class ListContentCategoryActionService extends BaseService implements ActionServiceIntf {
     ...
     *
     * 2. pull all content category list from database (if no criteria)
     *
    ...
    public Map execute(Map result) {
        try {
            Map resultMap = super.getSearchResult(result, ListContentCategoryActionServiceModel.class)
