 ...
 *  For details go through Use-Case doc named 'ListForSendSmsActionService'
 */
class ListForSendSmsActionService extends BaseService implements ActionServiceIntf {
    ...
    public Map execute(Map result) {
        try {
            Map resultMap = super.getSearchResult(result, ListForSendSmsActionServiceModel.class)
