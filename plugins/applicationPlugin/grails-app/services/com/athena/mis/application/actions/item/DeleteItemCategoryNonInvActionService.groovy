...
/**
 *  Class to delete item (Category: Non-Inventory)
 *  For details go through Use-Case doc named 'DeleteItemCategoryNonInvActionService'
 */

class DeleteItemCategoryNonInvActionService extends BaseService implements ActionServiceIntf {
