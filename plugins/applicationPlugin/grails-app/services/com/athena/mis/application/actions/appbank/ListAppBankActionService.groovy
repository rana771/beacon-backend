 ...
 */
class ListAppBankActionService extends BaseService implements ActionServiceIntf {
     ...
     *
     * 2. pull all bank list from database (if no criteria)
     *
    ...
    public Map execute(Map result) {
        try {
            Map resultMap = super.getSearchResult(result, ListBankActionServiceModel.class)
