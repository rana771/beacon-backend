 ...
 */
class ListItemTypeActionService extends BaseService implements ActionServiceIntf {
     ...
     *
     * 2. pull all item type list from database (if no criteria)
     *
    ...
    public Map execute(Map result) {
        try {
            Map resultMap = super.getSearchResult(result, ListItemTypeActionServiceModel.class)
