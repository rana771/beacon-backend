 ...
 */
class ListAppGroupActionService extends BaseService implements ActionServiceIntf {

    private Logger log = Logger.getLogger(getClass())

    /**
     * No pre conditions required for searching AppGroup domain
     ...
     * 2. pull all AppGroup list from database (if no criteria)
    ...
    public Map execute(Map result) {
        try {
            Map resultMap = super.getSearchResult(result, AppGroup.class)
