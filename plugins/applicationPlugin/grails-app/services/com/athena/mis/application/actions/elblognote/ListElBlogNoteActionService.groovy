...
class ListElBlogNoteActionService extends BaseService implements ActionServiceIntf {

     private Logger log = Logger.getLogger(getClass());
    /**
     * No pre conditions required for searching elBlogNote domains
     *
     ...
     *
     * 2. pull all elBlogNote list from database (if no criteria)
     *
    ...
    public Map execute(Map result) {
        try {
            Map resultMap = super.getSearchResult(result, ElBlogNote.class)
