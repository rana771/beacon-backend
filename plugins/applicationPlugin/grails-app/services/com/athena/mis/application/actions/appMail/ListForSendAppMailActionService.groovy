 ...
 *  For details go through Use-Case doc named 'ListForSendAppMailActionService'
 */
class ListForSendAppMailActionService extends BaseService implements ActionServiceIntf {
    ...
    public Map execute(Map result) {
        try {
            ...
            Map resultMap = super.getSearchResult(result, ListForSendAppMailActionServiceModel.class, additionalCondition)
