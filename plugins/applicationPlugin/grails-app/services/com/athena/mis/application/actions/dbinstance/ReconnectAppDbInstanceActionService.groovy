...
class ReconnectAppDbInstanceActionService extends BaseService implements ActionServiceIntf {
    ...
    private static final String SUCCESS_MESSAGE = "Database has been reconnected successfully"
    ...
    Map execute(Map previousResult) {
        try {
            ...
            Map result = dataAdapter.reconnect()
