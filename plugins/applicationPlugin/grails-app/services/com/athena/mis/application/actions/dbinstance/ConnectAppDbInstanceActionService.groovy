...
class ConnectAppDbInstanceActionService extends BaseService implements ActionServiceIntf {
    ...
    private static final String SUCCESS_MESSAGE = "Database has been connected successfully"
    ...
    Map execute(Map previousResult) {
        try {
            ...
            Map result = dataAdapter.connect()
