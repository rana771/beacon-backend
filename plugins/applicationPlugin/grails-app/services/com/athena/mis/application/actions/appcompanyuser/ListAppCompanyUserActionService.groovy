 ...
 */
class ListAppCompanyUserActionService extends BaseService implements ActionServiceIntf {
     ...
     *
     * 2. pull all company user list from database (if no criteria)
     *
    ...
    public Map execute(Map result) {
        try {
            Map resultMap = super.getSearchResult(result, ListAppCompanyUserActionServiceModel.class)
