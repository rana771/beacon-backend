 ...
 */
class ListItemCategoryInventoryActionService extends BaseService implements ActionServiceIntf {
    ...
    public Map execute(Map result) {
        try {
            SystemEntity itemSysEntityObject = appSystemEntityCacheService.readByReservedId(appSystemEntityCacheService.SYS_ENTITY_ITEM_CATEGORY_INVENTORY, appSystemEntityCacheService.SYS_ENTITY_TYPE_ITEM_CATEGORY, super.companyId)
            Closure filterParam = {
                eq("categoryId", itemSysEntityObject.id)
            }
            Map resultMap = super.getSearchResult(result, ListItemCategoryInventoryActionServiceModel.class, filterParam)
