 ...
 */
class ListSupplierActionService extends BaseService implements ActionServiceIntf {
     ...
     *
     * 2. pull all supplier list from database (if no criteria)
     *
    ...
    public Map execute(Map result) {
        try {
            Map resultMap = super.getSearchResult(result, ListSupplierActionServiceModel.class)
