...
/**
 * List Mail
 * for details please go through use case named 'ListMailForAppMailActionService'
 */
class ListAppMailForMailActionService extends BaseService implements ActionServiceIntf {
